...
The current Android architecture and the disposition of the earlier mobile
experiments are recorded in [`docs/android-direction.md`](docs/android-direction.md).
